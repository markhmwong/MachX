...
@implementation DebuffSlowCharge
...
- (id) initWithGame:(Game*)game Position:(CGPoint)position {
    if (self = [super init]) {
        ...
        self.spriteBody = [CCSprite spriteWithFile:@"SlowCharge-hd.png"];
...
- (void) addBody {
    ...
    [[GB2ShapeCache sharedShapeCache] addFixturesToBody:_body forShapeName:@"SlowCharge-hd"];
