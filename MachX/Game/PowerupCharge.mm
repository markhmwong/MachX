...
#import "PowerupCharge.h"


@implementation PowerupCharge
@synthesize spriteBody = _spriteBody;
@synthesize game = _game;
@synthesize body = _body;

+ (id) InitCharge:(Game*)game Position:(CGPoint)position {
...
- (id) initWithGame:(Game*)game Position:(CGPoint)position {
    if (self = [super init]) {
        ...
        self.spriteBody = [CCSprite spriteWithFile:@"Recharge-hd.png"];
        self.spriteBody.tag = 11;
...
- (void) addBody {
    ...
    [[GB2ShapeCache sharedShapeCache] addFixturesToBody:_body forShapeName:@"Recharge-hd"];
